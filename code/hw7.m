function [net, info] = hw7()
%code for Computer Vision, Georgia Tech by James Hays
%based off the MNIST and CIFAR examples from MatConvNet
cd 
run(fullfile('Z:','adit','Desktop','hw7','matconvnet-1.0-beta16', 'matlab', 'vl_setupnn.m')) ;
...
% Problem 1, adding jitters / Mirroring

size_batch = size(batch, 2);

for i=1:1:size_batch
